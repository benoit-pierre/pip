...
class BuildEnvironment(object):
    ...
    def check_requirements(self, reqs):
        """Return 2 sets:
            - list of requirements from reqs that are conflicting
            - list of requirements from reqs that are not present
        """
        missing = set()
        conflicting = set()
    ...
    def install_requirements(self, finder, requirements, prefix, message):
        ...
        args = [
            ...
            '--no-user', '--prefix', prefix.path, '--no-warn-script-location',
        ]
